    ...
    <div className="relative h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#70C7BA] to-[#49EACB]">
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex items-center justify-between space-x-8">
        ...
        <div className="flex flex-col items-center text-center text-white w-1/2">
          <h1 className="text-5xl font-bold mb-2">Welcome to Katpool</h1> {/* Maintained small margin-bottom for spacing */}
          <p className="text-2xl mb-16">Nacho Typical Kaspa Mining Pool</p> {/* Increased margin-bottom for larger spacing */}
          <div className="space-x-4">
            <button
              className="bg-white text-black font-bold py-2 px-4 rounded shadow-md hover:shadow-lg transform hover:-translate-y-1 transition duration-300 ease-in-out"
              onClick={() => navigate('/get-connected')}
            >
              Get Connected
            </button>
            <button
